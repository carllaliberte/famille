...
**Cadence $0 (Carl opère le verrou).** `/swarm` = Gemini natif seulement. Checkout = tête de PR, pas `main`. Commentaire seulement si HTTP 200. Skip 503/402/404 = log Actions, pas un mur. Tests + LU + PR : ça roule sans payer.
