...
| famille | plagiat-watch | Radar canaris publics. Spec `unforge-check/PLAGIAT-WATCH.md`. `workflow_dispatch` seulement. Branche `docs/plagiat-watch` (pas `bloc/` — CI `nom`). dispatch Carl, PR pas main. Pas une 2e exception AUTOMATION.md. Pas ots-bot. |
