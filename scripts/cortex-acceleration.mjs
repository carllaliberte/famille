...
export function runAccelerationFabric(input = {}) {
  ...
  if (sovereignty.breaker.status === "HOLD_HUMAN") {
    return {
      ...
      cpu: { identity: "cpu-local", state: "DEFINED", live: false },
      unknown: describeAccelerator({ id: "FUTURE_ACCELERATOR_X", kind: "UNKNOWN", vendor: "UNKNOWN" }),
      ...
      gates: { merge: false, write: false, nvidia_is_architecture: false, second_cortex: false, second_fabric: false },
      sovereignty,
      secrets_used: false,
      nvidia_called: false,
      fake_success: false,
