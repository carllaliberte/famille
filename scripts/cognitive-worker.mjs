...
export function runWorker(opts = {}) {
  ...
  const measurementRecord = buildMeasurementRecord({ env, observedAt: ranking.observed_at, observation, ranking, feedback, memoryIndex, dispatches });
