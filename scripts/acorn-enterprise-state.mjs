...
export const STATE_ENTITIES=Object.freeze(["CUSTOMER","PROJECT","OFFER","TASK","EXECUTION","CONNECTION","INTELLIGENCE","EVIDENCE","MONEY_CLAIM","ASSET","PRODUCT","EVENT"]);
...
export function evidenceRecord({tenantId,claim,source,kind="OBSERVATION",strength=0,margin=0,validUntil=null}={}){
 const measured=Number.isFinite(strength)&&strength>0&&Number.isFinite(margin)&&margin>0;
 return {id:uid("evidence"),tenant_id:tenantId||null,claim,source,kind,strength,margin,valid_until:validUntil,status:measured?"MEASURED":"INSUFFICIENT",measured_at:ISO()};
}
