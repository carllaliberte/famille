...
Champ manquant → aperçu classique. Pas une vente à quatre cartes. Pas un finding `detect.v0`.

- Chemin : [ACTES.md](ACTES.md). Carl écrit les prix. Les bots n'inventent pas. Les lignes ACTES ne sont pas un tarif.
...
3. **Acte** — voir [ACTES.md](ACTES.md).
4. **CI** — Action `unforge-check` chez d'autres repos (wedge gratuit, audit payant).
5. **Formation / pack lieu** — BCP 47 + silence agent.

## Gratuit (wedge)

Schémas MIT, preview grok.me, check.py, packs de phrases, Garde examples.
Preview ≠ quittance.
