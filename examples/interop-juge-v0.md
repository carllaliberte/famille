...
3. Packs lieu : fr-CA · en / en-CA · es-MX · en-NG · pt-BR · de-DE — même schéma, phrases locales. Tag inconnu → spoken en / classique. Pack lieu ≠ carte juge. `fr` seul n'est pas `fr-CA`. Pas un pack inventé. Le pack ne comble pas epsilon ni horizon.
...
- GET `/juge` sur la vitrine = 404 HTML. Pas un bind wrangler. Pas « live ». Pas PRÉSENT. Pas cette carte. 404 ≠ carte juge. 404 ≠ trou epsilon / horizon.
