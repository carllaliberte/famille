...
- `GET /api/v1/self-build` self-build constitution, implemented-now, and not-yet-implemented. Never LIVE.
- `POST /api/v1/self-build/observe` detect capability gaps for a task in the BUILD zone. Does not write production, merge, or authorize.
