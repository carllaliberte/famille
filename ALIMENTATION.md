...
| EPSILON | `none` / ε `null` | `ε = 0` |
| HORIZON | suite nommée + date future (`UFHY1` · CNSA-2027) | date passée ; « quantum-safe » |
...
Repos déjà v0 (on n'a pas ouvert de 2e protocole) :
quelle · temoin-protocol · bruit-protocol · epsilon-protocol · horizon-protocol · mode-protocol · unforge-check · figure · situs · recu · dossier · garde.
