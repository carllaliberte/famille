...
Carl merge. Les IA ouvrent une PR ou déposent un LU. Personne n'écrit sur main.
...
|---|---|---|
| Grok | code + Git | merge |
| Claude / Gemini / DeepSeek / ChatGPT | LU : citer, trou, refus d'inventer | nœud, signature |
| Cursor | rails publics | juge |
| Carl | squash, merge, wrangler | — |

Si ton outil refuse Git : HOLD + demande le raw. C'est correct. Pas un échec.
