...
3. Cadence $0 : `/swarm` = Gemini natif. Checkout = tête de PR (pas `main`). Commentaire seulement si HTTP 200. Skip 400/402/403/404/429/503 = log, pas un mur sur le fil. Exit 0.
